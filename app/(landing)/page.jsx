...
import FooterAlternative from "@/app/ui/layout/footer/FooterAlternative"
    ...
    return (
        <Box sx={{ flexGrow: 1, display: "flex", flexDirection: "column", bgcolor: "background.default" }} component="main">
            <Box sx={{ flexGrow: 1, position: "relative", justifyContent: "center", alignItems: "center", display: "flex" }}>
                <LogoSvg sx={{ opacity: 0.3, position: 'absolute', height: "100%", width: "auto", maxWidth: "100%", top: 0, right: 0, color: "text.secondary" }} />
