...
export const DraggableAboveNodes = (props) => {
...
export const Draggable = withRef(({ className, ...props }, ref) => {
  ...
  return (
    (<div
      ...
      <Gutter>
        <div
          className={cn('slate-blockToolbarWrapper', 'flex h-[1.5em]', isType(editor, element, [
            HEADING_KEYS.h1,
            HEADING_KEYS.h2,
            HEADING_KEYS.h3,
            HEADING_KEYS.h4,
            HEADING_KEYS.h5,
          ]) && 'h-[1.3em]', isInColumn && 'h-4', isInTable && 'mt-1 size-4')}>
          <div
            className={cn(
              'slate-blockToolbar',
